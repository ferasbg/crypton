...
class Client(flwr.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        return parameters, num_examples_train 
...
if __name__ == '__main__':
    ...
    network_client = Client(model, gaussian_state=False, x_train=x_train, y_train=y_train, x_test=x_test, y_test=y_test)

    flwr.client.start_numpy_client("[::]:8080", client=network_client)